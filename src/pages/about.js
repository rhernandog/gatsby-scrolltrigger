...
const AboutPage = () => {
  ...
  useIsomorphicLayoutEffect(() => {
    const ctx = gsap.context(() => {
      ...
      gsap.to(".astronaut", {
        ...
        scrollTrigger: {
          trigger: motionContainer.current,
          pin: true,
          start: "top top",
          end: "+=150%",
          scrub: 1,
  ...
  return (
    <Layout>
      <section className="w-full h-screen bg-violet-600 flex justify-center items-center">
        <h1 className="text-4xl font-semibold text-white">ABOUT US PAGE</h1>
      </section>
      <section className="w-full h-screen bg-gray-100" ref={motionContainer}>
        <div className="w-full h-full flex justify-center items-center">
          <svg id="motionPath" style={{ overflow: "visible" }} viewBox="-20 0 557 190">
            <path
              id="path"
              fill="none"
              d="M8 102c7-19 50-77 123-78 75 0 102 39 128 67 33 34 69 64 118 64 87 0 120-58 127-81"
            ></path>
            <g className="astronaut">
              ...
              <path
                ...
                strokeMiterlimit="10"
                strokeWidth="1.439"
                d="M70.9 95.9c0-4.807 3.893-8.7 8.7-8.7 4.807 0 8.7 3.893 8.7 8.7 0 4.807-3.893 8.7-8.7 8.7a8.698 8.698 0 01-8.7-8.7z"
              ></path>
              <path
                fill="#FFF"
              ...
              ></path>
              <g fill="#FFF">
                <path d="M73.3 95.3a.7.7 0 111.4 0 .7.7 0 01-1.4 0z"></path>
                <path d="M73.9 95.3c0-.663.045-1.2.1-1.2.055 0 .1.537.1 1.2 0 .663-.045 1.2-.1 1.2-.055 0-.1-.537-.1-1.2z"></path>
                <path d="M72.7 95.3c0-.055.582-.1 1.3-.1.718 0 1.3.045 1.3.1 0 .055-.582.1-1.3.1-.718 0-1.3-.045-1.3-.1z"></path>
              </g>
              <g fill="#FFF">
                <path d="M84.1 93.4a.7.7 0 111.4 0 .7.7 0 01-1.4 0z"></path>
                <path d="M84.7 93.4c0-.663.045-1.2.1-1.2.055 0 .1.537.1 1.2 0 .663-.045 1.2-.1 1.2-.055 0-.1-.537-.1-1.2z"></path>
                <path d="M83.5 93.4c0-.055.582-.1 1.3-.1.718 0 1.3.045 1.3.1 0 .055-.582.1-1.3.1-.718 0-1.3-.045-1.3-.1z"></path>
              </g>
            </g>
          </svg>
        </div>
